#ifndef CAMERA_CAMERAWORKERTASK_TASK_HPP
#define CAMERA_CAMERAWORKERTASK_TASK_HPP

#include "camera/CameraWorkerTaskBase.hpp"
...
namespace camera {
    class CameraWorkerTask : public CameraWorkerTaskBase
    {
	friend class CameraWorkerTaskBase;
    protected:
    
    

    public:
        CameraWorkerTask(std::string const& name = "camera::CameraWorkerTask", TaskCore::TaskState initial_state = Stopped);
